function compute_OFBrox(video_names,param)
...
%     images=dir(sprintf('%s/%s/*%s',impath,vidname));
%     images = {images.name};
    
    [fileNames, numImages] = gzget_training_images(impath, vidname);
